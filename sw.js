...
const CACHE=CACHE_PREFIX+'v1.4.41';
const ASSETS=[
...
if(url.pathname.endsWith('/label.html')||url.pathname.endsWith('label.html')||url.pathname.endsWith('/open-label.html')||url.pathname.endsWith('open-label.html'))return;
